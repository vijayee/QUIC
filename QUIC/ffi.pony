...
use @quic_connection_shutdown_initiated_by_transport_data_status[U32](event: Pointer[None] tag)
use @quic_connection_shutdown_initiated_by_transport_data_error_code[U64](event: Pointer[None] tag)
...
use @quic_get_stream_event_type_as_int[I32](event: Pointer[None] tag)
...
use @quic_new_server_event_context[Pointer[None] tag](serverActor: QUICServer, cb: Pointer[None] tag, queue: Pointer[None] tag, configuration: Pointer[None] tag, connectionCb: Pointer[None] tag)
...
use @quic_server_listener_start[None](listener: Pointer[None] tag, alpn: Pointer[Pointer[U8] tag] tag, alpnSize: U32, family: I32, ip: Pointer[U8] tag, port: U16)?
...
use @quic_queue_empty[I32](queue: Pointer[None] tag)
use @quic_server_event_from_wrapper[Pointer[None] tag](wrapper: Pointer[None] tag)
use @quic_server_connection_context_from_wrapper[Pointer[None] tag](wrapper: Pointer[None] tag)
use @quic_server_connection_queue_from_context[Pointer[None] tag](ctx: Pointer[None] tag)
use @quic_server_configuration_status_from_wrapper[I32](wrapper: Pointer[None] tag)
